...
#Recebendo informações (dataXsensor4
data_inicial = '2011/04/25  18:06:00'
data_final = '2011/04/26 18:05:00'
...
plt.suptitle("Sensores de Temperatura TGA 13/05/2011")
plt.tight_layout()  
plt.savefig("Sensores de Temperatura TGA_13_05_2011.png")  
plt.show()  
...
plt.suptitle("Sensores de Temperatura TGB 13/05/2011")
plt.tight_layout()  
plt.savefig("Sensores de Temperatura TGB_13_05_2011.png")  
plt.show()  
...
plt.tight_layout()  
plt.savefig("Sensores de Temperatura TGC_13_05_2011.png")  
plt.show()  
...
plt.suptitle("Sensores de Temperatura TGD 13/05/2011")
plt.tight_layout()  
plt.savefig("Sensores de Temperatura_OIF_26_04_2011.png")  
plt.show()  
"""

#Plotagem dos gráficos em subplot
fig, ((ax1),(ax2),(ax3),(ax4)) = plt.subplots(4, 1, figsize=(18, 15))
fig.suptitle("Sensores de Temperatura 26/04/2011",fontsize=20)
ax1.plot(y,)
...
fig.tight_layout()  
plt.savefig("Sensores de Temperatura_OIF_26_04_2011_subplot.png")
plt.show() 
